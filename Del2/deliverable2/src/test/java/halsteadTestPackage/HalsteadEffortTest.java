...
public class HalsteadEffortTest {
    ...
    @Test
    void beginTreeTest() {
    	HalsteadEffort spyEffort = spy(new HalsteadEffort());
    ...
    void getDefaultTokensTest() {
    	HalsteadEffort effort = new HalsteadEffort();
    	assertArrayEquals(tokenTypes, effort.getDefaultTokens());
    }
    ...
    void getAcceptableTokensTest() {
   		 HalsteadEffort effort = new HalsteadEffort();
   		assertArrayEquals(tokenTypes, effort.getAcceptableTokens());
    }
    
    @Test
    void getRequiredTokensTest() {
   		 HalsteadEffort effort = new HalsteadEffort();
   		assertArrayEquals(tokenTypes, effort.getRequiredTokens());
    }
    ...
    void finishTreeTest() {
   		HalsteadEffort spyEffort = spy(new HalsteadEffort());
   		DetailAST mockAST = mock(DetailAST.class);
    	String message = "Halstead Effort: 0";
