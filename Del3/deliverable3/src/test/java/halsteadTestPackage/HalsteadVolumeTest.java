...
public class HalsteadVolumeTest {
	...
	@Test
	void beginTreeTest() {
		HalsteadVolume spyVolume = spy(new HalsteadVolume());
	...
	@Test
	void getDefaultTokenTest() {
		HalsteadVolume volume = new HalsteadVolume();
		assertArrayEquals(tokenTypes, volume.getDefaultTokens());
	}
	...
	void getAcceptableTokenTest() {
		HalsteadVolume volume = new HalsteadVolume();
		assertArrayEquals(tokenTypes, volume.getAcceptableTokens());
	}
	
	@Test
	void getRequiredTokenTest() {
		HalsteadVolume volume = new HalsteadVolume();
		assertArrayEquals(tokenTypes, volume.getRequiredTokens());
	}
	...
	void finishTreeTest() {
		 HalsteadVolume spyVolume = spy(new HalsteadVolume());
		 DetailAST mockAST = mock(DetailAST.class);
	 		String message = "Halstead Volume: 0";
